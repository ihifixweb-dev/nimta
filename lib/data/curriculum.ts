...
const defaultCurriculum: CurriculumDetail = {
  ...
  mods: [
    'Full module-by-module curriculum available from NIMTA Admissions: admissions@nimta.edu.ng',
  ],
